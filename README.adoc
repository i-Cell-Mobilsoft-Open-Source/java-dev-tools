...
== Setting up with Spotless Maven plugin:
...
<plugin>
    ...
    <configuration>
        ...
        <java>
            <cleanthat/>
            <eclipse>
                <file>icellmobilsoft-eclipse-code-formatter.xml</file>
            </eclipse>
            <importOrder>
    ...
    <dependencies>
        <dependency>
            ...
            <artifactId>java-dev-tools</artifactId>
...
2) Run `mvn spotless:check` or `mvn spotless:apply`

For detailed instructions on configuring and using the Spotless Maven plugin, refer to the https://github.com/diffplug/spotless/tree/main/plugin-maven[official documentation].
